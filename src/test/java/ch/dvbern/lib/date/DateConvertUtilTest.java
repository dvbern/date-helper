...
public class DateConvertUtilTest extends TestCase {
    ...
    public void testConvertAsInstant() throws Exception {
    ...
    public void testConvertAsLocalDate() throws Exception {
        //Datum ohne Zeit
    ...
    public void testConvertAsLocalDateTime() throws Exception {
    ...
    public void testConvertAsZonedDateTime() throws Exception {
