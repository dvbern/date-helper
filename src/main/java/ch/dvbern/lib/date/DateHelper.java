...
public class DateHelper {
     ...
     * 
     * @param date
     *            Datum an dem die dayCount Tage hinzu addiert werden
     * @param dayCount
     *            Anzahl Tage hinzuaddieren.
     ...
     * 
     * @param date
     *            Datum an dem die anzahl Monate hinzu addiert werden
     * @param anzahl
     *            Anzahl monate hinzuaddieren (kann auch negaativ sein
     * @return java.util.Date
     */
     ...
     * 
     * @param date
     *            Datum an dem die Monate addiert werden
     * @param monthCount
     *            Anzahl Monate hinzuaddieren. Kann auch negativ sein
     * @param withEndMonthCheck
     *            Letzter Tag des Monats wird berücksichtigt
     * @return java.util.Date
     */
     ...
     * 
     * @param date
     *            Datum an dem die anzahl Jahre hinzu addiert werden
     * @param anzahl
     *            Anzahl Jahre hinzuaddieren (kann auch negaativ sein)
     * @return java.util.Date
     */
     ...
     * 
     * @param date
     *            Datum von welchem das Datum verwendet wird
     * @param time
     *            Datum von welchem die Zeit verwendet wird
     * @return java.util.Date
     */
     ...
     *            Index des Monats
     * @param year
     *            Jahr in dem die anzahl Tage des Monats ermittelt werden
     *            sollen.
     ...
     *            (1-12)
     * @param year
     *            ist das jahr 0, wird es auf 1 gesetzt (0 ist nicht zulässig)
     * @return java.util.Date
     */
     ...
     * @param von
     * @param bis
     * @param inklusiveDatumVon
     *            angabe, ob das vonDatum auch mitgezählt werden soll
     ...
     * 
     * @param initialValue
     *            Initialer Datums-Wert des Kalenders
	...
	return new java.util.Date(myCalendar1.getTime().getTime());
    }
     ...
     * 
     * @param field
     *            das zu lesende Feld. Muss eines von {@link Calendar#YEAR},
     ...
     * @param date
     *            das Datum von welchem gelesen werden soll.
     ...
     *            Geburtsdatum
     * @param stichdatum
     *            Datum, an welchem das Alter berechnet werden soll
     * @return das Alter
     */
